...
study_name = f"lightgbm_tuning_{VERSION}_IV_Vol_longerTestPeriod_run2"
...
best_params_df.to_csv(OUT_DIR / f"LightGBM_EURUSD_ES_hyperparams_{VERSION}.csv", index=False)
